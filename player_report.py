...
def display_player_report():
    ...
    start_date = st.date_input("Start Date", min_value=min(gps_df['Session Date']), max_value=max(gps_df['Session Date']), value=min(gps_df['Session Date']))
    end_date = st.date_input("End Date", min_value=min(gps_df['Session Date']), max_value=max(gps_df['Session Date']), value=max(gps_df['Session Date']))
