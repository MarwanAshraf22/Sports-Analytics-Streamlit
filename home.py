...
def display_home():
    ...
    st.write("""
    Our all-in-one **sports analytics platform** is built to **empower athletes and coaches**, with a special focus on supporting **People of Determination**.
    ...
    - 🤕 Early injury detection powered by AI  
    - 🧠 Personalized, adaptive training plans  

    Together, we're building a future where **every athlete thrives**.
    """)
